...
public class lab07 {
    ...
    public void TC1_guru(){
        ...
        ID.sendKeys("mngr398049");
        WebElement pass = driver.findElement(By.xpath("//input[@type='password']"));
        pass.sendKeys("EqEjEpY");
        WebElement loginButton = driver.findElement(By.xpath("//input[@type='submit']"));
        loginButton.click();

        WebElement visibleTx = driver.findElement(By.xpath("//td[.='Manger Id : mngr398049']"));
        Assert.assertTrue(visibleTx.getText().contains("Manger Id : mngr398049"), "Failed. Home Page doesn't contain Manger Id : mngr397424");
        ...
        //
        //
        //Registered Customer details are as follows:
        //
        //Customer ID	76047
        //Customer Name	leo
        //Gender	male
        //Birthdate	1989-06-06
        //Address	1378 candlelite dr
        //City	Franklin
        //State	TN
        //Pin	444444
        //Mobile No.	0123456789
        //Email	info10112@renastech.com
        //Continue
